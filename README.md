...
- 팀 프로젝트(5명) : 강병천, 강하영(팀장), 박성민, 박지영, 조윤지
</br>
...
### 6.2. 공지사항(조윤지), 로케이션 구현(박지영)
  - 로케이션 : 카카오 위치 API 구현 
  - 공지사항 : 게시판, 상세페이지 구현
 
### 6.3. 상품 페이지, 파일 업로드, Qna 게시판 구현 (강병천)
...
### 6.4. 상품 상세페이지, 페이지네이션, 후기 게시판 구현 (조윤지)
  - 상품 상세페이지 옵션 선택, 주문하기 , 장바구니 버튼, 해당 상품 후기, 문의 구현
  - 게시판 페이지네이션 구현
  - 후기 게시판 등록, 수정, 삭제 구현
  - 마이페이지 내 후기 팝업창 구현
 
### 6.5. 장바구니, 주문 및 결제 구현 (박성민)
